      ...
      <div className="container-padding relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {craftSteps.map((step, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-full bg-[#578E7E]/10">
                <step.icon className="w-8 h-8 text-[#578E7E]" />
              </div>
        ...
        <div className="mt-24 max-w-4xl mx-auto">
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-px bg-[#578E7E]/20" />
            {[
              'Design Consultation',
              'Material Selection',
              'Pattern Creation',
              ...
              >
                <div className="w-4 h-4 rounded-full bg-[#578E7E] relative">
                  <div className="absolute inset-0 rounded-full bg-[#578E7E] animate-ping opacity-20" />
                </div>
