...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative bg-[#F5ECD5] py-12 sm:py-16 md:py-24">
      {/* Background Pattern */}
      ...
      >
        <span className="inline-block px-3 py-1 mb-4 sm:mb-6 text-[#A76D6D] bg-[#A76D6D]/10 rounded-full text-sm font-medium">
        Our Story
        </span>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-[#3D3D3D] leading-tight">
        Crafting Beauty with Purpose
        </h2>
        <p className="text-base sm:text-lg text-[#3D3D3D]/70 max-w-2xl mx-auto px-4 sm:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-sm rounded-lg p-6 sm:p-8 text-center shadow-sm"
        >
          <div className="inline-flex items-center justify-center w-12 h-12 mb-4 sm:mb-6 rounded-full bg-[#A76D6D] text-[#FFFAEC]">
          {feature.icon}
          </div>
          <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-[#3D3D3D]">
          {feature.title}
          </h3>
